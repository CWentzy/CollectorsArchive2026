...
namespace MTGWebScraper
{
    internal class Program
    {
        ...
        const string _connectionString = "Server=tcp:collectorsarchive.database.windows.net,1433;Initial Catalog=collectorsarchivedb;Persist Security Info=False;User ID=collectorsarchive2026;Password=Conestoga2026;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
